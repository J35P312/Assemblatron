...
def main(args,wd):
    ...
    os.system("samtools view -h -F 2048 {} | samtools view -F 1024 -Sh - | samtools view -Subh -F 256 - | samtools sort -n - | samtools bam2fq - | bwa mem -t {} {} -p - | samtools view -Sbh - | samtools sort - > {}/{}.bam".format(args.bam,args.cores,args.contigs,args.wd,args.prefix))
